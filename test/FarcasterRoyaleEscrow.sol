...
contract FarcasterRoyaleEscrowTest is Test {
    ...
    bytes constant TEST_SIGNATURE =
        hex"76a4535b1008306afcfe89c0d7271219ada50c18bbbf19fb924a319c325f49266fec3856a9f01afa3e7e60ade8f5184cbec7f4e0414d4cb314b1981ed447855e1c";
    ...
    event BattleResolved(uint256 battleId, FarcasterRoyaleEscrow.Outcome outcome);
    ...
    function testBattleProposalNative() public {
        ...
        assertEq(uint256(_outcome), uint256(FarcasterRoyaleEscrow.Outcome.NONE));
    ...
    function testClaimWinnerChallenger() public {
        ...
        farcasterRoyaleEscrow.claim(1, TEST_MESSAGE_HASH, TEST_SIGNATURE, FarcasterRoyaleEscrow.Outcome.CHALLENGER);
    ...
    function testSignatureVerification() public {
        address recovered = farcasterRoyaleEscrow.recoverSigner(TEST_MESSAGE_HASH, TEST_SIGNATURE);
        assertEq(recovered, trustedSigner);
    }

    function testDrawOutcome() public {
        // Constants for draw test
        bytes memory DRAW_SIGNATURE =
            hex"38fd86a4965506edc0d73ce6fa9a2b25af2c3dd5d2cbbfe66d404600f817dcaa134c59678136f0db6e61b88727f33f2134690b0ccaa3b4e9729a03b02a09e77d1b";
        ...
        vm.prank(challenger);
        farcasterRoyaleEscrow.claim(1, DRAW_MESSAGE_HASH, DRAW_SIGNATURE, FarcasterRoyaleEscrow.Outcome.DRAW);
